      ...
      <div className="flex gap-4 justify-center items-center flex-wrap">
        ...
        >
          <LazyLoadImage
            ...
            alt="experience"
          />
          <h3 className="text-sm font-bold">{t("whyus.1")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="teaching"
          />
          <h3 className="text-sm font-bold">{t("whyus.2")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="online-course"
          />
          <h3 className="text-sm font-bold">{t("whyus.3")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="scholarship"
          />
          <h3 className="text-sm font-bold">{t("whyus.4")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="period"
          />
          <h3 className="text-sm font-bold">{t("whyus.5")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="easy"
          />
          <h3 className="text-sm font-bold">{t("whyus.6")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="handling"
          />
          <h3 className="text-sm font-bold">{t("whyus.7")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="webinar"
          />
          <h3 className="text-sm font-bold">{t("whyus.8")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="choice"
          />
          <h3 className="text-sm font-bold">{t("whyus.9")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="24-hours"
          />
          <h3 className="text-sm font-bold">{t("whyus.10")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="flexible"
          />
          <h3 className="text-sm font-bold">{t("whyus.11")}</h3>
        </motion.div>
        <motion.div
          variants={item}
          className="item flex flex-col items-center gap-4 bg-[#4caf50] text-white hover:bg-[#FF932D] hover:text-black p-6 py-6 transtion duration-200 w-60 text-center h-[200px]"
        >
          <LazyLoadImage
            ...
            alt="salary"
          />
          <h3 className="text-sm font-bold">{t("whyus.12")}</h3>
        </motion.div>
      </div>
    </motion.section>
  );
